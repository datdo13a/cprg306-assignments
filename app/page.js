  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li><Link href="/week-6" className="hover:text-blue-400 hover:underline">Week 6: Handling Lists</Link></li>
        <li><Link href="/week-7" className="hover:text-blue-400 hover:underline">Week 7: Managing State</Link></li>
      </ul>
    </div>
  )
}
