...
export function NewItem({ onAddItem }) {
  ...
  return (
    <div className="bg-gray-100 p-10 m-10 rounded-3xl shadow-lg flex flex-col items-center justify-center">
      <h1 className="mb-2 text-6xl font-bold text-gray-500 mb-10">
        Add Groceries
      </h1>
      ...
      <div>
        ...
        <input
          ...
          value={name}
          className="bg-blue-100 rounded-lg p-2 m-2 mb-6"
        ></input>
      </div>
      ...
      <div>
        <div className="justify-center flex">
          <label className="mb-2 text-4xl font-bold text-gray-500">
            Category
          </label>
        </div>
      ...
      <div>
        <button
          className="bg-blue-300 rounded-lg pl-12 pr-12 pt-4 pb-4 m-4 hover:bg-blue-400 active:bg-blue-500 text-white font-bold text-xl"
